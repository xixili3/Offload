...
const aiSantaOnButton = document.querySelector('#aiSantaOn');
const aiEmojiOnButton = document.querySelector('#aiEmojiOn');
const aiSooOnButton = document.querySelector('#aiSooOn');
const aiMancityOnButton = document.querySelector('#aiMancityOn');
const aiMadridOnButton = document.querySelector('#aiMadridOn');
const aiChelseaOnButton = document.querySelector('#aiChelseaOn');
const aiEffectOffButton = document.querySelector('#aiEffectOff');
...
function applyVideoConstraints(constraints) {
  if (!stream) {
    return;
  }
...
aiZoomOffButton.onclick = () => {
  applyVideoConstraints({ "tizenAiAutoZoomTarget": { "exact": "none" } });
};

aiSantaOnButton.onclick = () => {
  applyVideoConstraints({ "santa": true })
};

aiEmojiOnButton.onclick = () => {
  applyVideoConstraints({ "emoji": true })
};

aiSooOnButton.onclick = () => {
  applyVideoConstraints({ "soo": true })
};

aiMancityOnButton.onclick = () => {
  applyVideoConstraints({ "mancity": true })
};

aiMadridOnButton.onclick = () => {
  applyVideoConstraints({ "madrid": true })
};

aiChelseaOnButton.onclick = () => {
  applyVideoConstraints({ "chelsea": true })
};

aiEffectOffButton.onclick = () => {
  applyVideoConstraints({})
};
